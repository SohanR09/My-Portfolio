    ...
    return (
      <SectionContainer id="experience" background="primary">
        ...
        <div className="space-y-12">
          {[...Array(3)].map((_, index) => (
            <div key={index} className="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-6 animate-pulse">
                ...
                <div className="flex-grow">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[...Array(4)].map((_, skillIndex) => (
                      <div key={skillIndex} className="h-8 bg-gray-300 dark:bg-gray-700 rounded-full w-20"></div>
                    ))}
                  </div>
                </div>
              </div>
      ...
      <SectionContainer id="experience" background="primary">
        ...
        <div className="text-center py-12">
          <p className="text-gray-600 dark:text-gray-400">
            {error || "Experience information will be available soon. Please check back later."}
          </p>
        </div>
      </SectionContainer>
    )
          ...
          >
            <div className="flex flex-col md:flex-row items-center md:items-start">
              ...
              <div className="flex-grow">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300">{exp.position}</p>
