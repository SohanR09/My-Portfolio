...
import { SECTION_TITLES, CONTACT_TEXT } from "@/constants"
import { Mail, Linkedin, Github, ExternalLink, Check, Copy } from "lucide-react"
  ...
  return (
    <SectionContainer id="contact" background="light">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-xl mb-8 text-gray-700 dark:text-gray-300">{CONTACT_TEXT}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              <div className="p-3 rounded-full bg-red-100 dark:bg-red-900 mb-3">
                <Mail className="w-10 h-10 text-red-500 dark:text-red-400" />
              </div>
            ...
            >
              <div className="p-3 rounded-full bg-blue-100 dark:bg-blue-900 mb-3">
                <Linkedin className="w-10 h-10 text-[#0A66C2] dark:text-[#0A66C2]" />
              </div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">LinkedIn</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">Professional Profile</p>
              <Button
                variant="ghost"
                size="sm"
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <div className="p-3 rounded-full bg-gray-100 dark:bg-gray-900 mb-3">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">Code Repository</p>
              <Button
                variant="ghost"
                size="sm"
      ...
      >
        ...
        <span className="text-green-800 dark:text-green-200">Email copied to clipboard!</span>
      </Toast>
    </SectionContainer>
  )
}
