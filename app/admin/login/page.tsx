    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">Sign in to manage your portfolio</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">This area is restricted to administrators only</p>
        </CardFooter>
      </Card>
    </div>
  )
